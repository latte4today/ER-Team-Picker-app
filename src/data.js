...
export const characters = [
  ...
  c("lucia", "루치아", "mage", ["poke", "range", "burst", "cc"], "skill", 4),
  ...
  c("blair", "블레어", "bruiser", ["poke", "zone", "burst"], "skill", 3),
  ...
  c("karla", "칼라", "mage", ["poke", "range", "cc"], "skill", 4),
  ...
  c("craver", "크레이버", "mage", ["poke", "burst", "mobility", "focus"], "skill", 4),
  ...
  c("henry", "헨리", "mage", ["range", "poke", "objective"], "skill", 3),
...
export const ccProfiles = {
  ...
  lucia: cc({ nonTarget: 2, narrow: 1, single: 1 }),
  ...
  craver: cc({ nonTarget: 2, narrow: 2, conditional: 1 }),
